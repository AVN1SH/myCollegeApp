    ...
    <div className="relative m-1 w-[clac(100%-280px)]">
      ...
      <div className="absolute border-slate-400 border-[1px] border-solid flex flex-col bg-gray-100 w-[calc(100%-5px)] md:w-[calc(100%-60px)] lg:w-[calc(100%-100px)] top-16 md:top-20 lg:top-24 left-1/2 -translate-x-1/2 min-h-[calc(100vh-11rem)] rounded lg:p-3 p-1">
        <div className="bg-white mb-1 rounded p-2 pl-2 w-full h-fit">
          {userData && <h1 className="scroll-m-20 font-extrabold tracking-tight text-4xl text-slate-700"><span className="text-orange-600">Welcome</span> To My College "{userData.first_name + ' ' + (userData.middle_name ? userData.middle_name : '') + ' ' + (userData.last_name ? userData.last_name : '')}"</h1>}
