...
const Banner = () => {
  return (
    <div className="bg-yellow-300 m-5 rounded p-5 hover:cursor-pointer h-[200px] md:h-[300px]">
      <p className="font-semibold text-gray-600 ">Home | Programs</p>
      <div className="max-w-md overflow-hidden mx-auto md:max-w-full mt-2 lg:mt-7 ">
