...
const EventAndNews = () => {
  ...
  return (
    <div className=" ml-2 w-[calc(100%-20px)] p-2 mt-5">
      ...
      <div className="grid grid-cols-1 gap-x-3 gap-y-5 md:grid-cols-2 xl:grid-cols-3">
        {data?.newsEvents.map((value) => (
          <Link key={value.title} to='#' className="group shadow-[0_0_10px_rgba(0,0,0,0.25)] overflow-hidden max-w-md md:max-w-full mx-auto rounded bg-white hover:shadow-[0_0_10px_rgba(255,77,0,0.25)] md:h-[180px]">
              <div className="md:flex">
                <div className="md:shrink-0">
                  <img 
                    className="h-[400px] w-full object-top object-cover md:w-40 md:h-48" 
